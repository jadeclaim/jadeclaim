...
arbitrum-fork:
	ganache-cli --fork https://arb1.arbitrum.io/rpc --wallet.totalAccounts 10 \
	-m brownie \
	 --chain.allowUnlimitedContractSize true -k istanbul --miner.blockTime 0 --miner.instamine=eager --chain.vmErrorsOnRPCResponse
...
avax-fork-exploit:
	...
	-m brownie \
	 --chain.allowUnlimitedContractSize true -k istanbul --miner.blockTime 0 --miner.instamine=eager --chain.vmErrorsOnRPCResponse
generate-interfaces:
	python py_vector/py_vector/utils/interface_generation.py all
...
add-arbitrum-fork:
	brownie networks add Arbitrum arbitrum-fork host=http://127.0.0.1:8545 chainid=42161 explorer=https://api.arbiscan.io/api

bsc-fork:
	ganache-cli --fork https://bsc-dataseed.binance.org --wallet.totalAccounts 10 \
	-m brownie \
	 --chain.allowUnlimitedContractSize true -k istanbul --miner.blockTime 0 --miner.instamine=eager --chain.vmErrorsOnRPCResponse
