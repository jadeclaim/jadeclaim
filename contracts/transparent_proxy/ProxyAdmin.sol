...
contract ProxyAdmin is Ownable {
    ...
    function submitTimelockUpgrade(TransparentUpgradeableProxy proxy, uint256 newTimelock)
        public
        onlyOwner
    {
     ...
     * - This contract must be the admin of `proxy`.
     */
    function upgradeTimelock(TransparentUpgradeableProxy proxy) public virtual onlyOwner {
